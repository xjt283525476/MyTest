...
import com.sn.core.utils.JaxbUtils;
...
public class Test {
    ...
    public static <T> StringWriter beanToXml(T t) throws JAXBException, FileNotFoundException {
        ...
        m.marshal(t, sw);
        m.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, false);// 是否格式化
    ...
    public static void main(String[] args) throws JAXBException, FileNotFoundException {
        ...
        StringWriter sw = JaxbUtils.beanToXml(smsDeliverReq, false);
//        StringWriter sw = beanToXml(smsDeliverReq);
        System.out.println(sw.toString());
        
        SmsDeliverReq xmlToBean = JaxbUtils.xmlToBean(sw.toString(), smsDeliverReq);
